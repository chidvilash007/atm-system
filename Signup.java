...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){ 
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("l17_atm/icons/logo.jpg"));
       ...
       // String formno = first;
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into signup(name,fname,date,month,year,gender,email,marital,address,city,pincode,state) values('"+a+"','"+b+"','"+ac+"','"+bc+"','"+cc+"' ,'"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"')";
        ...
        try{
            Conn c1 = new Conn();
            ResultSet rs = c1.s.executeQuery("select * from signup where email = '"+e+"'");
            while (rs.next()) {
                 id = rs.getInt("id");
                }
                new Signup2(id).setVisible(true);
                setVisible(false);
            }
