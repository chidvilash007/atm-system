    ...
    public void actionPerformed(ActionEvent ae){
        try{        
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals(c) && a.equals(p1) &&b!="00") {
                
                Conn c1 = new Conn();
                String q1 = "update bank set pin = '"+c+"' where cardno = '"+cardno+"' ";
                String q2 = "update login set pin = '"+c+"' where cardno = '"+cardno+"' ";
                String q3 = "update signup3 set pin = '"+c+"' where cardno = '"+cardno+"' ";
