        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    Conn c1 = new Conn();
                    String q1 = "insert into signup3 values('"+a+"','"+first8+"','"+first4+"','"+b+"','"+id+"')";  
                    String q2 = "insert into login values('"+first8+"','"+first4+"')";
                    String q3 = "insert into bank values('"+first8+"','"+first4+"','0')";
                    c1.s.executeUpdate(q1);
                    c1.s.executeUpdate(q2);
                    c1.s.executeUpdate(q3);
                    JOptionPane.showMessageDialog(null, "Card Number: " + first8 + "\n Pin:"+ first4);
                    String cardn=String.valueOf(first8);
                    new Deposit(cardn).setVisible(true);
                    setVisible(false);
                }
